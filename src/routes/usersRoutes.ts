...
router.get(
  ...
  (req: Request, res: Response) => {
    try {
      ...
      // // check if token is not provided and invalid format
      ...
      //     // extract "user" payload from custom request
      //     const Payload = req.user;

      //     const user = users.find((u) => u.username === (Payload as UserPayload).username);
